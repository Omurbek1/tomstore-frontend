...
const MailSuccess = () => {
  ...
  const isOrderSuccess = searchParams.get("kind") === "order";
  const pageTitle = isOrderSuccess
    ? t("mailSuccess.orderTitle")
    : t("mailSuccess.title");
  const headingKicker = isOrderSuccess
    ? t("mailSuccess.orderSuccessful")
    : t("mailSuccess.successful");
  const heading = isOrderSuccess
    ? t("mailSuccess.orderHeading")
    : t("mailSuccess.heading");
  const bodyText = isOrderSuccess
    ? t("mailSuccess.orderText")
    : t("mailSuccess.text");

  return (
    <>
      <Breadcrumb title={pageTitle} pages={[pageTitle]} />
