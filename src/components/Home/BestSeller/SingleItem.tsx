...
const SingleItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group h-full rounded-[28px] border border-white/10 bg-white/8 p-5 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-white/18 hover:bg-white/10">
      <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-white/6">
        ...
        <div className="absolute right-4 top-4 flex translate-x-3 flex-col gap-2 opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
          <button
            onClick={() => {
            ...
            id="bestOne"
            className="flex h-10 w-10 items-center justify-center rounded-full border border-white/12 bg-white/90 text-dark shadow-sm transition-colors duration-200 hover:bg-blue hover:text-white"
          >
            <svg
          ...
          <button
            ...
            className={`flex h-10 w-10 items-center justify-center rounded-full border shadow-sm transition-colors duration-200 ${
              isInWishlist
                ...
                : "border-white/12 bg-white/90 text-dark hover:bg-blue hover:text-white"
            }`}
          >
            <svg
              className="fill-current"
