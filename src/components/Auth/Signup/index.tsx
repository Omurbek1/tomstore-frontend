...
const Signup = () => {
  ...
  return (
    <>
      <Breadcrumb title={t("menu.signup")} pages={[t("menu.signup")]} />
              ...
              <form>
                <div className="mb-5">
                  <label htmlFor="name" className="block mb-2.5">
                    {t("auth.fullName")} <span className="text-red">*</span>
                  </label>
                ...
                <div className="mb-5">
                  <label htmlFor="email" className="block mb-2.5">
                    {t("auth.emailAddress")} <span className="text-red">*</span>
                  </label>
                ...
                <div className="mb-5">
                  <label htmlFor="password" className="block mb-2.5">
                    {t("auth.password")} <span className="text-red">*</span>
                  </label>
                ...
                <div className="mb-5.5">
                  <label htmlFor="re-type-password" className="block mb-2.5">
                    {t("auth.retypePassword")} <span className="text-red">*</span>
                  </label>
